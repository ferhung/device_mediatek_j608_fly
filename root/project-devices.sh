...
#mediatek-sw yexm1 add 20140324, for mediatek fm radio app  do not support RDS begin
setprop persist.mediatek.fmradio.rds off
#mediatek-sw yexm1 add 20140324, for mediatek fm radio app  do not support RDS end
